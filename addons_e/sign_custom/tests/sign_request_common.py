...
class SignRequestCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.role_employee = cls.env.ref('sign_custom.sign_item_role_employee')
        ...
        cls.env['sign.item'].create([
            {
                ...
                'type_id': cls.env.ref('sign.sign_item_type_text').id,
                'required': True,
                'responsible_id': cls.env.ref('sign_custom.sign_item_role_employee').id,
                'page': 1,
                'posX': 0.373,
                'posY': 0.258,
                'template_id': cls.template_3_roles.id,
        ...
        cls.user_1 = new_test_user(cls.env, login="user_1", groups='sign_custom.group_sign_user')
        ...
        cls.user_2 = new_test_user(cls.env, login="user_2", groups='sign_custom.group_sign_user')
        ...
        cls.user_3 = new_test_user(cls.env, login="user_3", groups='sign_custom.group_sign_user')
        ...
        cls.user_4 = new_test_user(cls.env, login="user_4", groups='sign_custom.group_sign_user')
    ...
    def create_sign_request_3_roles(self, customer, employee, company, cc_partners):
        sign_request = self.env['sign.request'].create({
            ...
            'request_item_ids': [Command.create({
                ...
                'role_id': self.env.ref('sign_custom.sign_item_role_employee').id,
            }), Command.create({
