...
class SignLog(models.Model):
    ...
    # Accessed as ?
    user_id = fields.Many2one('res.users', groups="sign_custom.group_sign_manager")
    ...
    latitude = fields.Float(digits=(10, 7), groups="sign_custom.group_sign_manager")
    longitude = fields.Float(digits=(10, 7), groups="sign_custom.group_sign_manager")
    ip = fields.Char("IP address of the visitor", required=True, groups="sign_custom.group_sign_manager")
    ...
    request_state = fields.Selection([
        ...
        ("canceled", "Cancelled"),
        ("expired", "Expired"),
    ], required=True, string="State of the request on action log", groups="sign_custom.group_sign_manager")
