...
import { multiFileUpload } from "@sign_custom/backend_components/multi_file_upload";
import { user } from "@web/core/user";
import { getDataURLFromFile } from "@web/core/utils/urls";
import { TemplateAlertDialog } from "@sign_custom/backend_components/template_alert_dialog/template_alert_dialog";
...
export function useSignViewButtons() {
    ...
    onWillStart(async () => {
        component.isSignUser = await user.hasGroup("sign_custom.group_sign_user");
    });
