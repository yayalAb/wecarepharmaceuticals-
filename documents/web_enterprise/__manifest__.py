    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            ('after', 'web/static/src/views/list/list_renderer.xml',
             'web_enterprise/static/src/views/list/list_renderer_desktop.xml'),
        ...
        "web.dark_mode_variables": [
            ...
            ('before', 'web_enterprise/static/src/**/*.variables.scss',
             'web_enterprise/static/src/**/*.variables.dark.scss'),
            # web._assets_secondary_variables
            ('before', 'web_enterprise/static/src/scss/secondary_variables.scss',
