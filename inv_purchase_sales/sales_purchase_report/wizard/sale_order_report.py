...
class SalesReport(models.TransientModel):
    ...
    def action_print_pdf(self):
        ...
        return self.env.ref(
            'sales_purchase_report.sale_report_report_action_report_custom').report_action(
            self, data=data)

    def action_view(self):
        datas = self.action_return_data()
        self.env['sale.report.tree'].search([]).unlink()
        datas = datas
        report_line_vals = []
        ...
        self.env['sale.report.tree'].create(report_line_vals)
        return {
