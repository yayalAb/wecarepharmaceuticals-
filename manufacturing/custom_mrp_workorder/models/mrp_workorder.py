...
class MrpProductionWorkcenterLine(models.Model):
    ...
    def verify_quality_checks(self):
        for check in self.check_ids:
            ...
            if check.test_type in ['register_consumed_materials', 'register_byproducts', 'instructions']:
                ...
                raise UserError(_("You need to complete Quality Checks before marking Work Order as Done."))
    ...
    def action_open_mes(self):
        action = self.env['ir.actions.actions']._for_xml_id('custom_mrp_workorder.action_mrp_display')
        action['context'] = {
    ...
    def action_mrp_workorder_dependencies(self, action_name):
        ...
        ref = 'custom_mrp_workorder.workcenter_line_gantt_production_dependencies' if action_name == 'production' else 'custom_mrp_workorder.mrp_workorder_view_gantt_dependencies'
